...
## Project Structure
    ...
    ├── throbbing_paper_dev_99659  # Django project configurations
...
1. Clone this repo and `cd throbbing_paper_dev_99659`
...
2. Clone this repo and `cd throbbing_paper_dev_99659`
